                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="../assets/img/avatars/rabbit.jpeg" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <img
                          src="../assets/img/avatars/rabbit.jpeg"
                          alt="user-avatar"
                    ...
                    <div class="card-body">
                      <form id="formAccountSettings" method="POST" action="update_user.php" style="display: none;">
                        ...
                        <div class="mb-3 col-md-6">
                          ...
                          <div class="mb-3 col-md-6">
                            <label for="state" class="form-label">거주 지역</label>
                            <input class="form-control" type="text" id="address" name="address" placeholder="ex) 서울" />
                          </div>
                          <!--세션 처리 -->
                    ...
                    <button id="editButton" type="button" class="btn btn-primary me-2">정보 수정하기</button>
